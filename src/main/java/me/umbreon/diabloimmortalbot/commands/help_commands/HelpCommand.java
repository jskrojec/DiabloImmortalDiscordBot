...
public class HelpCommand {
    ...
    private MessageEmbed buildHelpMessage(String guildLanguage) {
        ...
        embedBuilder.addField(">server language", LanguageController.getHelpServerLanguageMessage(guildLanguage), false);
        embedBuilder.addField(">server timezone", LanguageController.getHelpServerTimezoneMessage(guildLanguage), false);
